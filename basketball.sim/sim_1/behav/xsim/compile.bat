...
REM
REM Generated by Vivado on Tue Dec 02 16:14:48 +0900 2025
...
echo "xvlog --incr --relax -prj basketball_tb_vlog.prj"
call xvlog  --incr --relax -prj basketball_tb_vlog.prj -log xvlog.log
