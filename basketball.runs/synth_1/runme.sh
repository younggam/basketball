...
HD_PWD='C:/Users/admin/vivado_projects/basketball/basketball.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log basketball.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source basketball.tcl
