...
synth_design -top basketball -part xc7a75tfgg484-1
...
write_checkpoint -force -noxdef basketball.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file basketball_utilization_synth.rpt -pb basketball_utilization_synth.pb"  } 
