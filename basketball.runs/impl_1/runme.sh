...
HD_PWD='C:/Users/admin/vivado_projects/basketball/basketball.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log basketball.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source basketball.tcl -notrace
